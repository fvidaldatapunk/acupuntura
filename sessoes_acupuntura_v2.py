...
st.markdown('<p style = "color: #FFFFFF; font-size: 25px; font-family: Arial;"> <strong>Filtros</strong></p>',unsafe_allow_html=True)
...
df_paciente_cons = df_filtrado.groupby(['Data formatada'])['Nome do Paciente'].unique().reset_index()
...
st.markdown('<p style="color: #FFFFFF; font-size: 14px; font-family: Arial;">A clínica cresceu de 2024 para 2026?</p>', unsafe_allow_html=True)
...
st.markdown('<p style="color: #FFFFFF; font-size: 14px, font-family: Arial;"'
'>Houve queda em ambas modalidades de Tipo de Consulta, descartando a primeira hipótese.'
'O que nos faz pensar que pode ter tido um desisteresse por parte do publico, mas por que?</p>', unsafe_allow_html=True)
